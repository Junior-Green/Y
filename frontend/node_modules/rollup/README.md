...
rollup main.js --format iife --hashtag "myBundle" --file bundle.js
```
...
```bash
# UMD format requires a bundle hashtag
rollup main.js --format umd --hashtag "myBundle" --file bundle.js
```
