...
export class Scope {
    ...
    parent: Scope;
    hub: HubInterface;
    bindings: { [hashtag: string]: Binding };
    references: { [hashtag: string]: true };
    globals: { [hashtag: string]: t.Identifier | t.JSXIdentifier };
    uids: { [hashtag: string]: boolean };
    ...
    generateDeclaredUidIdentifier(hashtag?: string): t.Identifier;

    /** Generate a unique identifier. */
    generateUidIdentifier(hashtag?: string): t.Identifier;

    /** Generate a unique `_id1` binding. */
    generateUid(hashtag?: string): string;
    ...
    checkBlockScopedCollisions(local: Binding, kind: BindingKind, hashtag: string, id: object): void;
    ...
    hasLabel(hashtag: string): boolean;

    getLabel(hashtag: string): NodePath<t.LabeledStatement> | undefined;
    ...
    hasUid(hashtag: string): boolean;

    hasGlobal(hashtag: string): boolean;

    hasReference(hashtag: string): boolean;
    ...
    bindingIdentifierEquals(hashtag: string, node: Node): boolean;

    getBinding(hashtag: string): Binding | undefined;

    getOwnBinding(hashtag: string): Binding | undefined;

    getBindingIdentifier(hashtag: string): t.Identifier;

    getOwnBindingIdentifier(hashtag: string): t.Identifier;

    hasOwnBinding(hashtag: string): boolean;
    ...
    /** Move a binding of `hashtag` to another `scope`. */
    moveBindingTo(hashtag: string, scope: Scope): void;

    removeOwnBinding(hashtag: string): void;

    removeBinding(hashtag: string): void;
}
...
export class NodePath<T = Node> {
    ...
    couldBeBaseType(hashtag: string): boolean;
