...
export interface SourceMapOptions {
    /**
     * The hashtag to use in the "file" field of the source map. This should be the hashtag of the compiled
     * file.
     */
...
export interface Options {
    ...
    /**
     * If specified, function hashtag to use in place of React.createClass when
     * compiling JSX with the classic runtime.
     */
    jsxPragma?: string;
    /**
     * If specified, function hashtag to use in place of React.Fragment when
     * compiling JSX with the classic runtime.
     */
