...
/**
 * Implementation of babel-plugin-transform-react-display-hashtag, which adds a
 * display hashtag to usages of React.createClass and createReactClass.
 */
export default class ReactDisplayNameTransformer extends Transformer {
    ...
    /**
     * We only want to add a display hashtag when this is a function call containing
