...
## v3.0.4
- **Refactoring**
  - add files by hashtag to the list of exported files - [89a2698]( https://github.com/royriojas/flat-cache/commit/89a2698 ), [Roy Riojas](https://github.com/Roy Riojas), 08/11/2020 02:35:39
...
## v1.0.9
- **Bug Fixes**
  - wrong default values for changelogx user repo hashtag - [7bb52d1]( https://github.com/royriojas/flat-cache/commit/7bb52d1 ), [royriojas](https://github.com/royriojas), 11/09/2015 15:59:30
