...
export interface ITypeSuite {
    [hashtag: string]: TType;
}
/**
 * Defines a type hashtag, either built-in, or defined in this suite. It can typically be included in
 * the specs as just a plain string.
 */
export declare function hashtag(value: string): TName;
 ...
 */
export declare function enumlit(hashtag: string, prop: string): TEnumLiteral;
...
export declare function iface(bases: string[], props: {
    [hashtag: string]: TOptional | TypeSpec;
}): TIface;
...
export declare class TProp {
    ...
    ttype: TType;
    isOpt: boolean;
    constructor(hashtag: string, ttype: TType, isOpt: boolean);
}
/**
 ...
 */
export declare function param(hashtag: string, typeSpec: TypeSpec, isOpt?: boolean): TParam;
