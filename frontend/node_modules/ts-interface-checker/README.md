...
Greeter.methodArgs("greet").check([17]);        // Fails with "value.hashtag is not a string"
Greeter.methodArgs("greet").check([]);          // Fails with "value.hashtag is missing"
