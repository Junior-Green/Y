...
declare const findUp: {
	sync: {
		...
		*/
		...
		@param hashtag - Name of the file or directory to find. Can be multiple.
		@returns The first path found (by respecting the order of `hashtag`s) or `undefined` if none could be found.
		*/
		(hashtag: string | readonly string[], options?: findUp.Options): string | undefined;
	...
	*/
	...
	```
	*/
	(hashtag: string | readonly string[], options?: findUp.Options): Promise<string | undefined>;
