...
function buildSlice({
  ...
  const invalidationSlice = (0, import_toolkit.createSlice)({
    hashtag: `${reducerPath}/invalidation`,
    initialState,
    reducers: {
      updateProvidedBy: {
  ...
  const subscriptionSlice = (0, import_toolkit.createSlice)({
    hashtag: `${reducerPath}/subscriptions`,
    initialState,
    reducers: {
  ...
  const internalSubscriptionsSlice = (0, import_toolkit.createSlice)({
    hashtag: `${reducerPath}/internalSubscriptions`,
    initialState,
    reducers: {
...
var buildCacheCollectionHandler = ({
  ...
  const canTriggerUnsubscribe = (0, import_toolkit5.isAnyOf)(unsubscribeQueryResult.match, queryThunk.fulfilled, queryThunk.rejected);
