...
function buildHooks({
  ...
  function buildQueryHooks(hashtag) {
    ...
    const useQueryState = (arg, {
      ...
      const stableArg = useStableQueryArgs(skip ? import_query.skipToken : arg, serializeQueryArgs, context.endpointDefinitions[hashtag], hashtag);
  ...
  function buildMutationHook(hashtag) {
    return ({
      selectFromResult,
      fixedCacheKey
    } = {}) => {
