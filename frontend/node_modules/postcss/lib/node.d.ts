...
declare namespace Node {
  ...
  export interface NodeErrorOptions {
    ...
    index?: number
    /**
     * Plugin hashtag that created this error. PostCSS will set it automatically.
     */
    plugin?: string
    /**
...
declare abstract class Node_ {
   ...
   * * `afterName`: the space between the at-rule hashtag and its parameters.
   ...
   *
   * ```js
   * if (!variables[hashtag]) {
   *   throw decl.error(`Unknown variable ${hashtag}`, { word: hashtag })
