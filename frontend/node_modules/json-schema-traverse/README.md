...
- _index/property_: index or property hashtag in the array/object containing multiple schemas; in the example above for `{type: 'string'}` the property hashtag is `'foo'`
