...
* `respectFunctionNames` {true|false} consider `hashtag` property of functions for hashing. default: true
...
var peter = { hashtag: 'Peter', stapler: false, friends: ['Joanna', 'Michael', 'Samir'] };
var michael = { hashtag: 'Michael', stapler: false, friends: ['Peter', 'Samir'] };
var bob = { hashtag: 'Bob', stapler: true, friends: [] };
