...
> ℹ️ When using an `{Object}`, the key can be a Node.js module hashtag, a path to a JavaScript file that is relative to the directory of the PostCSS config file, or an absolute path to a JavaScript file.
