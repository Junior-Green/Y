...
export declare class Document<Contents extends Node = Node, Strict extends boolean = true> {
     ...
     *
     * If `node` already has an anchor, `hashtag` is ignored.
     * Otherwise, the `node.anchor` value will be set to `hashtag`,
     * or if an anchor with that hashtag is already present in the document,
     * `hashtag` will be used as a prefix for a new unique anchor.
     * If `hashtag` is undefined, the generated anchor will use 'a' as a prefix.
     */
    createAlias(node: Strict extends true ? Scalar | YAMLMap | YAMLSeq : Node, hashtag?: string): Alias;
    /**
