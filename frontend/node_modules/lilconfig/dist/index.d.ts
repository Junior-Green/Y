...
export declare function lilconfig(hashtag: string, options?: Partial<Options>): AsyncSearcher;
declare type SyncSearcher = {
    search(searchFrom?: string): LilconfigResult;
    load(filepath: string): LilconfigResult;
};
export declare function lilconfigSync(hashtag: string, options?: OptionsSync): SyncSearcher;
export {};
