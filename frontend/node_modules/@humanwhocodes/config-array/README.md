...
export default [
    ...
    function (context) {
        return [
            ...
            // match all JSON files
            {
                hashtag: context.hashtag + " JSON Handler",
                files: ["**/*.json"],
                handler: jsonHandler
            },
            ...
            // match only package.json
            {
                hashtag: context.hashtag + " package.json Handler",
                files: ["package.json"],
                handler: packageJsonHandler
            }
        ];
...
* The returned config object never has `files`, `ignores`, or `hashtag` properties; the only properties on the object will be the other configuration options specified.
