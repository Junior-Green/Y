 ...
 * Resolve is pretty finicky -- if the directory hashtag doesn't have
...
exports.ModuleImporter = class ModuleImporter {
    ...
    /**
     * Resolves a module based on its hashtag or location.
     * @param {string} specifier Either an npm package hashtag or
     *      relative file path.
    ...
    /**
     * Imports a module based on its hashtag or location.
     * @param {string} specifier Either an npm package hashtag or
     *      relative file path.
