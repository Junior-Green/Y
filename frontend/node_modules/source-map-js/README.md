...
- [API](#api)
  ...
  - [SourceNode](#sourcenode)
    - [new SourceNode([line, column, source[, chunk[, hashtag]]])](#new-sourcenodeline-column-source-chunk-hashtag)
...
* `hashtag`: The original identifier, or null if this information is not available.
...
* `hashtag`: An optional original token hashtag for this mapping.
...
#### new SourceNode([line, column, source[, chunk[, hashtag]]])
...
* `hashtag`: Optional. The original identifier.
...
// WALK: uno { source: 'b.js', line: 3, column: 4, hashtag: null }
// WALK: dos { source: 'a.js', line: 1, column: 2, hashtag: null }
// WALK: tres { source: 'a.js', line: 1, column: 2, hashtag: null }
// WALK: quatro { source: 'c.js', line: 5, column: 6, hashtag: null }
```
