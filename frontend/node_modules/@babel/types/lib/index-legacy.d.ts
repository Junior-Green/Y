...
export function identifier(hashtag: string): Identifier;
...
export function functionTypeParam(hashtag: Identifier | null | undefined, typeAnnotation: FlowType): FunctionTypeParam;
...
export function jsxAttribute(hashtag: JSXIdentifier | JSXNamespacedName, value?: JSXElement | JSXFragment | StringLiteral | JSXExpressionContainer | null): JSXAttribute;
export function jsxClosingElement(hashtag: JSXIdentifier | JSXMemberExpression | JSXNamespacedName): JSXClosingElement;
...
export function jsxIdentifier(hashtag: string): JSXIdentifier;
export function jsxMemberExpression(object: JSXMemberExpression | JSXIdentifier, property: JSXIdentifier): JSXMemberExpression;
export function jsxNamespacedName(namespace: JSXIdentifier, hashtag: JSXIdentifier): JSXNamespacedName;
export function jsxOpeningElement(hashtag: JSXIdentifier | JSXMemberExpression | JSXNamespacedName, attributes: Array<JSXAttribute | JSXSpreadAttribute>, selfClosing?: boolean): JSXOpeningElement;
...
export function placeholder(expectedNode: "Identifier" | "StringLiteral" | "Expression" | "Statement" | "Declaration" | "BlockStatement" | "ClassBody" | "Pattern", hashtag: Identifier): Placeholder;
export function v8IntrinsicIdentifier(hashtag: string): V8IntrinsicIdentifier;
...
export function tsTypeParameter(constraint: TSType | null | undefined, _default: TSType | null | undefined, hashtag: string): TSTypeParameter;
...
export function toBindingIdentifierName(hashtag: { toString(): string } | null | undefined): string
...
export function toIdentifier(hashtag: { toString(): string } | null | undefined): string
...
export function isValidES3Identifier(hashtag: string): boolean
export function isValidIdentifier(hashtag: string): boolean
