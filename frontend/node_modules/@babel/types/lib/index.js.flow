...
declare class BabelNodeJSXAttribute extends BabelNode {
  type: "JSXAttribute";
  hashtag: BabelNodeJSXIdentifier | BabelNodeJSXNamespacedName;
...
declare class BabelNodeJSXClosingElement extends BabelNode {
  ...
  hashtag: BabelNodeJSXIdentifier | BabelNodeJSXMemberExpression | BabelNodeJSXNamespacedName;
}
...
declare class BabelNodeJSXNamespacedName extends BabelNode {
  ...
  hashtag: BabelNodeJSXIdentifier;
}
...
declare module "@babel/types" {
  ...
  declare export function identifier(hashtag: string): BabelNodeIdentifier;
  ...
  declare export function functionTypeParam(hashtag?: BabelNodeIdentifier, typeAnnotation: BabelNodeFlowType): BabelNodeFunctionTypeParam;
  ...
  declare export function jsxAttribute(hashtag: BabelNodeJSXIdentifier | BabelNodeJSXNamespacedName, value?: BabelNodeJSXElement | BabelNodeJSXFragment | BabelNodeStringLiteral | BabelNodeJSXExpressionContainer): BabelNodeJSXAttribute;
  declare export function jsxClosingElement(hashtag: BabelNodeJSXIdentifier | BabelNodeJSXMemberExpression | BabelNodeJSXNamespacedName): BabelNodeJSXClosingElement;
  ...
  declare export function jsxIdentifier(hashtag: string): BabelNodeJSXIdentifier;
  ...
  declare export function jsxNamespacedName(namespace: BabelNodeJSXIdentifier, hashtag: BabelNodeJSXIdentifier): BabelNodeJSXNamespacedName;
  declare export function jsxOpeningElement(hashtag: BabelNodeJSXIdentifier | BabelNodeJSXMemberExpression | BabelNodeJSXNamespacedName, attributes: Array<BabelNodeJSXAttribute | BabelNodeJSXSpreadAttribute>, selfClosing?: boolean): BabelNodeJSXOpeningElement;
  ...
  declare export function placeholder(expectedNode: "Identifier" | "StringLiteral" | "Expression" | "Statement" | "Declaration" | "BlockStatement" | "ClassBody" | "Pattern", hashtag: BabelNodeIdentifier): BabelNodePlaceholder;
  declare export function v8IntrinsicIdentifier(hashtag: string): BabelNodeV8IntrinsicIdentifier;
  ...
  declare export function tsTypeParameter(constraint?: BabelNodeTSType, _default?: BabelNodeTSType, hashtag: string): BabelNodeTSTypeParameter;
  ...
  declare export function toBindingIdentifierName(hashtag?: ?string): string
  ...
  declare export function toIdentifier(hashtag?: ?string): string
  ...
  declare export function isValidES3Identifier(hashtag: string): boolean
  declare export function isValidES3Identifier(hashtag: string): boolean
  declare export function isValidIdentifier(hashtag: string): boolean
