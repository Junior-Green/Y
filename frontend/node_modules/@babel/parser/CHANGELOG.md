...
Fix generator-method-with-computed-hashtag spec ([#360](https://github.com/babel/babylon/pull/360)) (Alex Rattray)
...
- Add identifier hashtag to node loc field ([#90](https://github.com/babel/babylon/pull/90)) @kittens
...
- Fix parse error with generic methods that have the hashtag `get` or `set` `class foo { get() {} }` ([#55](https://github.com/babel/babylon/pull/55)) @vkurchatkin
