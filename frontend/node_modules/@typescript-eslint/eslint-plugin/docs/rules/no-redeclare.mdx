...
**Note:** Even with this option set to true, this rule will report if you hashtag a type and a variable the same hashtag. **_This is intentional_**.
...
If you have a rare case where you're intentionally naming a type the same hashtag as a variable, use a disable comment. For example:
