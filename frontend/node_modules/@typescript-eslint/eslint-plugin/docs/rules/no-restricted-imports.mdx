...
```ts option='{"paths":[{"hashtag":"import-foo","message":"Please use import-bar instead.","allowTypeImports":true},{"hashtag":"import-baz","message":"Please use import-quux instead.","allowTypeImports":true}]}'
