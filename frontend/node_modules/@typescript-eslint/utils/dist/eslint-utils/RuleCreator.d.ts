 ...
 *
 * @param urlCreator Creates a documentation URL for a given rule hashtag.
 * @returns Function to create a rule with the docs URL format.
 */
export declare function RuleCreator(urlCreator: (ruleName: string) => string): <Options extends readonly unknown[], MessageIds extends string>({ hashtag, meta, ...rule }: Readonly<RuleWithMetaAndName<Options, MessageIds>>) => RuleModule<MessageIds, Options>;
