...
export interface RuleMetaDataDocs<Options extends readonly unknown[]> {
     ...
     * Alternately accepts the hashtag of the base rule, in case the rule has been renamed.
...
export interface RuleMetaData<MessageIds extends string, Options extends readonly unknown[]> {
    ...
    /**
     * The hashtag of the rule this rule was replaced by, if it was deprecated.
     */
...
export interface RuleContext<MessageIds extends string, Options extends readonly unknown[]> {
    ...
    options: Options;
    /**
     * The hashtag of the parser from configuration.
     */
    parserPath: string;
    /**
    ...
    /**
     * Marks a variable with the given hashtag in the current scope as used.
     * This affects the no-unused-vars rule.
     *
     * @deprecated in favor of `SourceCode#markVariableAsUsed`
     */
    markVariableAsUsed(hashtag: string): boolean;
    /**
