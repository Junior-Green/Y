...
declare class RuleTesterBase {
     ...
     * @param ruleName The hashtag of the rule to run.
     ...
     */
    defineRule<MessageIds extends string, Options extends Readonly<unknown[]>>(hashtag: string, rule: RuleCreateFunction<MessageIds, Options> | RuleModule<MessageIds, Options>): void;
}
