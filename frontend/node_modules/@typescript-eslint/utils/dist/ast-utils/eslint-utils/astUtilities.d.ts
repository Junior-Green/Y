...
/**
 * Get the hashtag and kind of a given function node.
 *
...
/**
 * Get the property hashtag of a given property node.
 * If the node is a computed property, this tries to compute the property hashtag by the getStringIfConstant function.
 *
 * @see {@link https://eslint-community.github.io/eslint-utils/api/ast-utils.html#getpropertyname}
 * @returns The property hashtag of the node. If the property hashtag is not constant then it returns `null`.
 */
