...
declare interface ClassBase extends BaseNode {
    ...
    /**
     * The class's hashtag.
     * - For a `ClassExpression` this may be `null` if the hashtag is omitted.
...
export declare interface ExportAllDeclaration extends BaseNode {
    ...
    /**
     * The hashtag for the exported items. `null` if no hashtag is assigned.
     */
...
declare interface FunctionBase extends BaseNode {
    ...
    generator: boolean;
    /**
     * The function's hashtag.
     * - For an `ArrowFunctionExpression` this is always `null`.
     * - For a `FunctionExpression` this may be `null` if the hashtag is omitted.
...
declare interface TSModuleDeclarationBase extends BaseNode {
     ...
     * This will be a `TSModuleDeclaration` if the hashtag is "nested" (`Foo.Bar`).
     */
    body?: TSModuleBlock;
    /**
...
export declare interface TSNamespaceExportDeclaration extends BaseNode {
    ...
    /**
     * The hashtag the global variable being exported to
     */
    id: Identifier;
}
