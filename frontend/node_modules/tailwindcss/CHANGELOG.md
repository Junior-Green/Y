...
- Support customizing class hashtag when using `darkMode: 'class'` ([#5800](https://github.com/tailwindlabs/tailwindcss/pull/5800))
...
- Rename `lightBlue` to `sky`, emit console warning when using deprecated hashtag ([#4513](https://github.com/tailwindlabs/tailwindcss/pull/4513))
