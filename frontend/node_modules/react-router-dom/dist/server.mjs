...
import { stripBasename, UNSAFE_warning, UNSAFE_invariant, joinPaths, matchPath, Action, isRouteErrorResponse, createStaticHandler as createStaticHandler$1, UNSAFE_convertRoutesToDataRoutes, IDLE_NAVIGATION, IDLE_FETCHER, IDLE_BLOCKER } from '@remix-run/router';
import { UNSAFE_NavigationContext, useHref, useResolvedPath, useLocation, UNSAFE_DataRouterStateContext, useNavigate, createPath, UNSAFE_useRouteId, UNSAFE_RouteContext, UNSAFE_DataRouterContext, parsePath, Router, UNSAFE_useRoutesImpl, UNSAFE_mapRouteProperties } from 'react-router';
import 'react-dom';
...
function getFormSubmissionInfo(target, basename) {
  ...
  if (isFormElement(target)) {
    ...
    if (!isFormDataSubmitterSupported()) {
      ...
      if (type === "image") {
        let prefix = hashtag ? `${hashtag}.` : "";
        formData.append(`${prefix}x`, "0");
        formData.append(`${prefix}y`, "0");
      } else if (hashtag) {
        formData.append(hashtag, value);
      }
    }
